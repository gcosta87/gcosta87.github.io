...
var textDelay = document.getElementById("delay").innerHTML;
var textCountDelay = textDelay.length;
...
var typeTextDelay = setInterval(function () {
    document.getElementById("delay").innerHTML += textDelay.substring(i, i + 1);
    i++;
    if (i >= textCountDelay) {
