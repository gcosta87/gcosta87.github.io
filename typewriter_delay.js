...
var text = document.getElementById("typewriter_delay").innerHTML;
var textCount = text.length;
//clear the element so we can type it out
document.getElementById("typewriter_delay").innerHTML = "";
var i = 0;
...
var typeText = setInterval(function () {
    document.getElementById("typewriter_delay").innerHTML += text.substring(i, i + 1);
    i++;
    if (i >= textCount) {
